...
public class FrameFilmes extends JFrame {
	...
	private JButton btnMostraTabela;
	...
	public FrameFilmes() {
		...
		btnMostraTabela = new JButton("Visualisar filmes");
		jpnNome = new JPanel();
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				Filmes filmes = new Filmes(txtNome.getText(), txtGenero.getText(), Integer.parseInt(txtCodigo.getText()));
		...
		btnMostraTabela.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
